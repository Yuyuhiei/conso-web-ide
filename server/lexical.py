...
class Lexer:
    ...
    def process_keyword_or_identifier(self):
        ...
        if key == 'n':
            if self.next_char() == 't':
                add_key()
                return Token(TT_INT, 'nt')
            elif self.next_char() == 'p':
                add_key()
                if self.next_char() == 't':
                    add_key()
                    return Token(TT_NPT, 'npt')
        elif key == 'p' and self.next_char() == 'r':
            add_key()
            if self.next_char() == 'n':
                add_key()
                if self.next_char() == 't':
                    add_key()
                    return Token(TT_KEYWORD, 'prnt')
        elif key == 'd':
            if self.next_char() == 'b':
                add_key()
                if self.next_char() == 'l':
                    add_key()
                    return Token(TT_KEYWORD, 'dbl')
                ...
                if self.next_char() == 'l':
                    ...
                    if self.next_char() == 't':
                        add_key()
                        return Token(TT_KEYWORD, 'dflt')
                elif self.next_char() == 's':
                    add_key()
                    if self.next_char() == 't':
                        add_key()
                        if self.next_char() == 'r':
                            ...
                            if self.next_char() == 'c':
                                ...
                                if self.next_char() == 't':
                                    add_key()
                                    return Token(TT_KEYWORD, 'dfstrct')
        elif key == 's':
            if self.next_char() == 't':
                add_key()
                if self.next_char() == 'r':
                ...
                if self.next_char() == 'r':
                    ...
                    if self.next_char() == 'c':
                        ...
                        if self.next_char() == 't':
                            add_key()
                            return Token(TT_KEYWORD, 'strct')
        elif key == 'b':
            if self.next_char() == 'r':
                add_key()
                if self.next_char() == 'k':
                    add_key()
                    return Token(TT_KEYWORD, 'brk')
            elif self.next_char() == 'l':
                add_key()
                if self.next_char() == 'n':
                    add_key()
                    return Token(TT_BOOL, 'bln')
        elif key == 'c':
            if self.next_char() == 's':
                add_key()
                return Token(TT_KEYWORD, 'cs')
                ...
                if self.next_char() == 's':
                    ...
                    if self.next_char() == 't':
                        add_key()
                        return Token(TT_KEYWORD, 'cnst')
        elif key == 'f':
            if self.next_char() == 'r':
                add_key()
                return Token(TT_KEYWORD, 'fr')
            elif self.next_char() == 'l':
                add_key()
                if self.next_char() == 's':
                    add_key()
                    return Token(TT_KEYWORD, 'fls')
            elif self.next_char() == 'n':
                add_key()
                if self.next_char() == 'c':
                    add_key()
            ...
            if self.next_char() == 't':
                ...
                if self.next_char() == 'r':
                    ...
                    if self.next_char() == 'n':
                        add_key()
                        return Token(TT_KEYWORD, 'rtrn')
        elif key == 'w' and self.next_char() == 'h':
            add_key()
            if self.next_char() == 'l':
                add_key()
                return Token(TT_KEYWORD, 'whl')
        elif key == 'v' and self.next_char() == 'd':
            add_key()
            return Token(TT_KEYWORD, 'vd')
        elif key == 'n':
            if self.next_char() == 'l':
                add_key()
                if self.next_char() == 'l':
                    add_key()
                    return Token(TT_KEYWORD, 'nll')
            elif self.next_char() == 'p':
                add_key()
                if self.next_char() == 't':
                    add_key()
                    return Token(TT_KEYWORD, 'npt')
        elif key == 'c' and self.next_char() == 'n':
            add_key()
            if self.next_char() == 't':
                add_key()
                if self.next_char() == 'n':
                    add_key()
                    return Token(TT_KEYWORD, 'cntn')
        elif key == 'm' and self.next_char() == 'n':
            add_key()
            return Token(TT_KEYWORD, 'mn')
        elif key == 't' and self.next_char() == 'r':
            add_key()
            return Token(TT_KEYWORD, 'tr')

        # If not a keyword, it's an identifier
        while self.current_char is not None and self.current_char.isalnum():
            key += self.current_char
            self.advance()
        return Token(TT_IDENTIFIER, key)
